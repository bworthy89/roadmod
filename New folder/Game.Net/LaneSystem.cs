...
public class LaneSystem : GameSystemBase
{
	...
	private struct UpdateLanesJob : IJobChunk
	{
				...
				for (int i = 0; i < nativeArray.Length; i++)
				{
					...
					if (nativeArray7.Length != 0)
					{
						...
						for (int j = 0; j < dynamicBuffer.Length; j++)
						{
							...
							GetNodeConnectPositions(connectedNode.m_Node, connectedNode.m_CurvePosition, nativeList, nativeList2, includeAnchored: true, ref groupIndex, out var _, out var _, out var _);
							...
							CreateEdgeConnectionLanes(chunkIndex, ref edgeLaneIndex, ref connectionIndex, ref random, owner, laneBuffer, nativeList, nativeList2, tempBuffer, tempBuffer2, composition.m_Edge, edgeGeometry, curve, isSingleCurve, nativeArray5.Length != 0, ownerTemp);
							nativeList.Clear();
							nativeList2.Clear();
						}
						CreateEdgeLanes(chunkIndex, ref random, owner, laneBuffer, composition, edge, edgeGeometry, segment, isSingleCurve, nativeArray5.Length != 0, ownerTemp);
					}
			...
			else if (nativeArray4.Length != 0)
			{
				...
				for (int k = 0; k < nativeArray.Length; k++)
				{
					...
					if (!flag)
					{
						...
						if (flag6)
						{
							flag6 = m_PrefabObjectGeometryData.TryGetComponent(prefabRef2.m_Prefab, out var componentData) && ((componentData.m_Flags & Game.Objects.GeometryFlags.DeleteOverridden) != Game.Objects.GeometryFlags.None || (componentData.m_Flags & (Game.Objects.GeometryFlags.Overridable | Game.Objects.GeometryFlags.Marker | Game.Objects.GeometryFlags.Brushable)) == 0);
						}
			...
			else
			{
				...
				for (int n = 0; n < nativeArray.Length; n++)
				{
					...
					if (nativeArray13.Length != 0)
					{
						...
						int groupIndex2 = 1;
						GetNodeConnectPositions(entity3, 0f, nativeList3, nativeList4, includeAnchored: false, ref groupIndex2, out var middleRadius2, out var roundaboutSize2, out var intersectionFlags2);
						...
						if (middleRadius2 > 0f && (roadTypes == RoadTypes.None || flag7))
						{
							if (nativeList5.Length != 0 || nativeList6.Length != 0)
							{
								...
								{
									ConnectPosition connectPosition = nativeList5[num5];
									flag8 &= connectPosition.m_RoadTypes == RoadTypes.Bicycle;
								...
								{
									ConnectPosition connectPosition2 = nativeList6[num6];
									flag8 &= connectPosition2.m_RoadTypes == RoadTypes.Bicycle;
									if ((connectPosition2.m_CompositionData.m_RoadFlags & (Game.Prefabs.RoadFlags.DefaultIsForward | Game.Prefabs.RoadFlags.DefaultIsBackward)) != 0)
									{
										if ((connectPosition2.m_CompositionData.m_RoadFlags & Game.Prefabs.RoadFlags.UseHighwayRules) != 0)
										{
											num3++;
										}
										else
								...
								ConnectPosition connectPosition3;
								bool flag9;
								if (nativeList5.Length != 0)
								{
									...
									for (int num8 = 0; num8 < nativeList5.Length; num8++)
									{
										...
										bool roundaboutLane2 = GetRoundaboutLane(nativeList7, roundaboutSize2, ref roundaboutLane, ref dedicatedLane, ref laneCount, ref laneWidth, ref isPublicOnly, ref spaceForLanes, isSource: true, preferHighway, flag8);
									...
									if (roundaboutLane.m_LaneData.m_Lane == Entity.Null)
									{
										...
										for (int num9 = 0; num9 < nativeList6.Length; num9++)
										{
											...
											GetRoundaboutLane(nativeList8, roundaboutSize2, ref roundaboutLane, ref dedicatedLane, ref laneCount2, ref laneWidth, ref isPublicOnly, ref spaceForLanes2, isSource: false, preferHighway, flag8);
											nativeList8.Clear();
										}
										laneCount = math.select(laneCount, 1, laneCount == 0 && laneCount2 != 0);
										spaceForLanes = spaceForLanes2 * (float)laneCount;
									}
									connectPosition3 = nativeList5[num7];
									flag9 = true;
								}
								else
								{
									...
									for (int num11 = 0; num11 < nativeList6.Length; num11++)
									{
										...
										bool roundaboutLane3 = GetRoundaboutLane(nativeList8, roundaboutSize2, ref roundaboutLane, ref dedicatedLane, ref laneCount, ref laneWidth, ref isPublicOnly, ref spaceForLanes, isSource: false, preferHighway, flag8);
										num10 = math.select(num10, num11, roundaboutLane3);
										nativeList8.Clear();
									}
									connectPosition3 = nativeList6[num10];
									flag9 = false;
								}
								ExtractNextConnectPosition(connectPosition3, position, nativeList5, nativeList6, out var nextPosition, out var nextIsSource);
								if (flag9)
								{
								...
								int laneCount3 = GetRoundaboutLaneCount(connectPosition3, nextPosition, nativeList7, nativeList8, nativeList4, position);
								connectPosition3 = nextPosition;
								flag9 = nextIsSource;
								nativeList7.Clear();
								nativeList8.Clear();
								...
								{
									ExtractNextConnectPosition(connectPosition3, position, nativeList5, nativeList6, out var nextPosition2, out var nextIsSource2);
									if (flag9)
									{
										FilterActualCarConnectPositions(connectPosition3, nativeList3, nativeList7);
									}
									...
									CreateRoundaboutCarLanes(chunkIndex, ref random4, entity3, laneBuffer, ref prevLaneIndex, -1, ref laneGroup, connectPosition3, nextPosition2, middleConnections, nativeList7, nativeList8, nativeList4, roundaboutLane, dedicatedLane, intersectionFlags2, position, middleRadius2, ref laneCount3, laneCount, length, spaceForLanes, roadTypes, flag7, nativeArray5.Length != 0, ownerTemp3);
									connectPosition3 = nextPosition2;
									flag9 = nextIsSource2;
									nativeList7.Clear();
									nativeList8.Clear();
								}
								...
								CreateRoundaboutCarLanes(chunkIndex, ref random4, entity3, laneBuffer, ref prevLaneIndex, nextLaneIndex, ref laneGroup, connectPosition3, nextPosition, middleConnections, nativeList7, nativeList8, nativeList4, roundaboutLane, dedicatedLane, intersectionFlags2, position, middleRadius2, ref laneCount3, laneCount, length, spaceForLanes, roadTypes, flag7, nativeArray5.Length != 0, ownerTemp3);
								nativeList7.Clear();
								nativeList8.Clear();
							}
						}
						else
						{
							...
							{
								ConnectPosition connectPosition4 = nativeList5[num12];
								int nodeLaneIndex = prevLaneIndex;
								if (roadTypes2 != connectPosition4.m_RoadTypes)
								{
									nativeList8.Clear();
									FilterActualCarConnectPositions(connectPosition4.m_RoadTypes, nativeList4, nativeList8);
									roadTypes2 = connectPosition4.m_RoadTypes;
								}
								int yield = CalculateYieldOffset(connectPosition4, nativeList5, nativeList6);
								FilterActualCarConnectPositions(connectPosition4, nativeList3, nativeList7);
								ProcessCarConnectPositions(chunkIndex, ref nodeLaneIndex, ref random4, entity3, nativeArray14[n].m_Prefab, laneBuffer, middleConnections, createdConnections, nativeList7, nativeList8, nativeList3, roadTypes, intersectionFlags2, nativeArray5.Length != 0, ownerTemp3, yield);
								nativeList7.Clear();
								for (int num13 = 0; num13 < nativeList6.Length; num13++)
								{
									ConnectPosition targetPosition = nativeList6[num13];
									if ((targetPosition.m_RoadTypes & connectPosition4.m_RoadTypes) == 0)
									{
										continue;
									}
									bool isUnsafe = false;
									...
									if (((connectPosition4.m_LaneData.m_Flags | targetPosition.m_LaneData.m_Flags) & LaneFlags.Master) != 0)
									{
										uint num15 = (uint)(connectPosition4.m_GroupIndex | (targetPosition.m_GroupIndex << 16));
										bool right;
										bool gentle;
										bool uturn;
										bool isTurn = IsTurn(connectPosition4, targetPosition, out right, out gentle, out uturn);
										float curviness = -1f;
										if (CreateNodeLane(chunkIndex, ref nodeLaneIndex, ref random4, ref curviness, ref isSkipped, entity3, laneBuffer, middleConnections, connectPosition4, targetPosition, intersectionFlags2, num15, 0, isUnsafe, isForbidden, nativeArray5.Length != 0, trackOnly: false, 0, ownerTemp3, isTurn, right, gentle, uturn, isRoundabout: false, isLeftLimit: false, isRightLimit: false, isMergeLeft: false, isMergeRight: false, fixedTangents: false, RoadTypes.None))
										{
											createdConnections.Add(new ConnectionKey(connectPosition4, targetPosition));
										}
									}
								}
								prevLaneIndex += 256;
						...
						{
							FilterPedestrianConnectPositions(nativeList4, nativeList5, middleConnections, num16 == 1);
						...
						while (utilityTypes != UtilityTypes.None)
						{
							if ((utilityTypes & utilityTypes2) != UtilityTypes.None)
							{
								...
								{
									CreateNodeUtilityLanes(chunkIndex, ref prevLaneIndex, ref random4, entity3, laneBuffer, nativeList8, nativeList7, middleConnections, position, middleRadius2 > 0f, nativeArray5.Length != 0, ownerTemp3);
									nativeList8.Clear();
									nativeList7.Clear();
								}
							}
						...
						CreateNodeConnectionLanes(chunkIndex, ref prevLaneIndex, ref random4, entity3, laneBuffer, middleConnections, nativeList8, intersectionFlags2, middleRadius2 > 0f, nativeArray5.Length != 0, ownerTemp3);
		...
		private void CreateOrphanLanes(int jobIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, Orphan orphan, float3 middlePosition, Entity prefab, ref int nodeLaneIndex, bool isTemp, Temp ownerTemp)
		{
			...
			if (num2 > num)
			{
				...
				CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, connectPosition2, connectPosition, pathNode, pathNode, default(float2), isCrosswalk: false, isSideConnection: true, isTemp, ownerTemp, fixedTangents: false, hasSignals: false, out var curve, out var middleNode, out var endNode);
				connectPosition.m_Tangent = -connectPosition.m_Tangent;
				connectPosition2.m_Tangent = -connectPosition2.m_Tangent;
				CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, connectPosition, connectPosition2, endNode, pathNode, default(float2), isCrosswalk: false, isSideConnection: true, isTemp, ownerTemp, fixedTangents: false, hasSignals: false, out curve, out middleNode, out var _);
			}
		}
		...
		private int GetRoundaboutLaneCount(ConnectPosition prevMainPosition, ConnectPosition nextMainPosition, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, NativeList<ConnectPosition> allTargets, float3 middlePosition)
		{
			...
			float num = ((!prevMainPosition.m_Position.Equals(nextMainPosition.m_Position)) ? (m_LeftHandTraffic ? MathUtils.RotationAngleRight(fromVector, toVector) : MathUtils.RotationAngleLeft(fromVector, toVector)) : (MathF.PI * 2f));
			int num2 = math.max(1, Mathf.CeilToInt(num * (2f / MathF.PI) - 0.003141593f));
		...
		private void CreateRoundaboutCarLanes(int jobIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, ref int prevLaneIndex, int nextLaneIndex, ref uint laneGroup, ConnectPosition prevMainPosition, ConnectPosition nextMainPosition, NativeList<MiddleConnection> middleConnections, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, NativeList<ConnectPosition> allTargets, ConnectPosition lane, ConnectPosition dedicatedLane, CompositionFlags intersectionFlags, float3 middlePosition, float middleRadius, ref int laneCount, int totalLaneCount, int totalSourceCount, float spaceForLanes, RoadTypes roadPassThrough, bool isDeadEnd, bool isTemp, Temp ownerTemp)
		{
			...
			float num = ((!prevMainPosition.m_Position.Equals(nextMainPosition.m_Position)) ? (m_LeftHandTraffic ? MathUtils.RotationAngleRight(@float, float2) : MathUtils.RotationAngleLeft(@float, float2)) : (MathF.PI * 2f));
			int num2 = math.max(1, Mathf.CeilToInt(num * (2f / MathF.PI) - 0.003141593f));
			float2 float3 = @float;
			float num3 = spaceForLanes;
			if (m_NetLaneData.TryGetComponent(dedicatedLane.m_LaneData.m_Lane, out var componentData))
			{
			...
			ConnectPosition connectPosition = new ConnectPosition
			{
				...
				m_Tangent = 
				{
					xz = (m_LeftHandTraffic ? MathUtils.Right(float3) : MathUtils.Left(float3))
				},
				m_SegmentIndex = (byte)(prevLaneIndex >> 8),
				m_Owner = owner,
				m_Position = 
				{
					y = middlePosition.y
			...
			for (int k = 1; k <= num2; k++)
			{
				...
				{
					xz = (m_LeftHandTraffic ? MathUtils.Right(float5) : MathUtils.Left(float5))
				};
				...
				float curviness = -1f;
				bool flag6 = roadPassThrough != RoadTypes.None || (isDeadEnd && (nextLaneIndex < 0 || flag3 || flag4));
				bool isUnsafe = flag6;
				bool isSkipped = false;
				for (int l = 0; l < num14; l++)
				{
					...
					if (l == num12)
					{
						...
						num18 = middleRadius + num3;
						num19 = middleRadius + num3;
					...
					else
					{
						...
						num18 = middleRadius + ((float)num17 + 0.5f) * spaceForLanes / (float)totalLaneCount;
						num19 = middleRadius + ((float)l + 0.5f) * spaceForLanes / (float)totalLaneCount;
					...
					connectPosition.m_Position.xz = middlePosition.xz + @float * num18;
					...
					if (l < num12 && num17 != l)
					{
						...
						endPos.xz = middlePosition.xz + float4 * num18;
						Bezier4x3 bezier4x = NetUtils.FitCurve(sourcePosition.m_Position, sourcePosition.m_Tangent, -targetPosition.m_Tangent, endPos);
						...
						CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition, targetPosition, intersectionFlags, laneGroup, (ushort)num16, flag6, isForbidden: false, isTemp, trackOnly: false, 0, ownerTemp, isTurn: false, isRight: false, isGentle: false, isUTurn: false, isRoundabout: true, a, b, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
					}
					else
					{
						curviness = -1f;
						CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, connectPosition, connectPosition2, intersectionFlags, laneGroup, (ushort)num16, flag6, isForbidden: false, isTemp, trackOnly: false, 0, ownerTemp, isTurn: false, isRight: false, isGentle: false, isUTurn: false, isRoundabout: true, a, b, isMergeLeft: false, isMergeRight: false, fixedTangents: false, roadPassThrough);
					}
					if (l == num12)
					{
				...
				{
					float num20 = middleRadius + (float)laneCount * 0.5f * spaceForLanes / (float)totalLaneCount;
					float num21 = middleRadius + (float)num12 * 0.5f * spaceForLanes / (float)totalLaneCount;
					connectPosition.m_Position.xz = middlePosition.xz + @float * num20;
					...
					curviness = -1f;
					CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, connectPosition, connectPosition2, intersectionFlags, laneGroup, 0, isUnsafe, isForbidden: false, isTemp, trackOnly: false, 0, ownerTemp, isTurn: false, isRight: false, isGentle: false, isUTurn: false, isRoundabout: true, isLeftLimit: false, isRightLimit: false, isMergeLeft: false, isMergeRight: false, fixedTangents: false, roadPassThrough);
				}
				laneGroup++;
				float num22 = 0f;
				if (flag3)
				{
					...
					{
						int num23 = math.select(m, num14 - m - 1, m_LeftHandTraffic);
						float num24;
						float num25;
						int index;
						if (m == num12)
						{
							...
							connectPosition2.m_LaneData.m_Lane = dedicatedLane.m_LaneData.m_Lane;
							connectPosition2.m_RoadTypes = dedicatedLane.m_RoadTypes;
							num24 = middleRadius + num3;
							num25 = middleRadius + num3;
							connectPosition2.m_LaneData.m_Flags = dedicatedLane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
						...
						else
						{
							...
							num24 = middleRadius + ((float)(m + totalLaneCount - math.max(num6, num12)) + 0.5f) * spaceForLanes / (float)totalLaneCount;
							num25 = middleRadius + ((float)m + 0.5f) * spaceForLanes / (float)totalLaneCount;
							connectPosition2.m_LaneData.m_Flags = lane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
							flag6 = num6 == 0;
						}
						centerPosition.xz = middlePosition.xz + float5 * num24;
						connectPosition2.m_Position.xz = middlePosition.xz + float4 * num25;
						...
						PresetCurve(ref sourcePosition2, ref targetPosition2, middlePosition, centerPosition, float6, num24, 0f, num / (float)num2, 2f);
						...
						if ((sourcePosition2.m_RoadTypes & targetPosition2.m_RoadTypes) != RoadTypes.None)
						{
							flag7 |= (sourcePosition2.m_LaneData.m_Flags & LaneFlags.Slave) != 0;
							CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition2, targetPosition2, intersectionFlags, laneGroup, (ushort)num23, flag6, isForbidden: false, isTemp, trackOnly: false, yield, ownerTemp, isTurn: false, isRight: false, isGentle: false, isUTurn: false, isRoundabout: true, a2, b2, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
						...
						{
							num22 = math.max(num22, math.distance(MathUtils.Position(bezier4x2, 0.5f).xz, middlePosition.xz));
						}
					}
					if (flag7)
					{
						...
						float num26 = math.lerp(start, end, 0.5f);
						centerPosition.xz = middlePosition.xz + float5 * num26;
						float num27 = middleRadius + (float)num12 * 0.5f * spaceForLanes / (float)totalLaneCount;
						connectPosition2.m_Position.xz = middlePosition.xz + float4 * num27;
						connectPosition2.m_LaneData.m_Index = (byte)math.select(0, num14, flag2);
						connectPosition2.m_LaneData.m_Flags = lane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
						connectPosition2.m_LaneData.m_Flags |= LaneFlags.Master;
						ConnectPosition sourcePosition3 = prevMainPosition;
						ConnectPosition targetPosition3 = connectPosition2;
						PresetCurve(ref sourcePosition3, ref targetPosition3, middlePosition, centerPosition, float6, num26, 0f, num / (float)num2, 2f);
						curviness = -1f;
						CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition3, targetPosition3, intersectionFlags, laneGroup, 0, isUnsafe, isForbidden: false, isTemp, trackOnly: false, yield, ownerTemp, isTurn: false, isRight: false, isGentle: false, isUTurn: false, isRoundabout: true, isLeftLimit: false, isRightLimit: false, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
					}
					laneGroup++;
				}
				if (flag4)
				{
					...
					int num28 = math.select(targetBuffer.Length, targetBuffer.Length + 1, num7 == targetBuffer.Length && dedicatedLane.m_LaneData.m_Lane != Entity.Null);
					isSkipped = false;
					isUnsafe = true;
					for (int n = 0; n < num28; n++)
					{
						int num29 = math.select(n, num28 - n - 1, m_LeftHandTraffic);
						int num30 = math.min(n, targetBuffer.Length - 1);
						num30 = math.select(targetBuffer.Length - num30 - 1, num30, m_LeftHandTraffic);
						int num31;
						float falseValue;
						float num32;
						if (num30 < num5 || num30 >= num5 + num7 || n >= targetBuffer.Length)
						{
							num31 = num13 - 1;
							connectPosition.m_LaneData.m_Lane = dedicatedLane.m_LaneData.m_Lane;
							connectPosition.m_RoadTypes = dedicatedLane.m_RoadTypes;
							...
							falseValue = math.select(falseValue, middleRadius + num3, num31 == laneCount || n >= targetBuffer.Length);
							num32 = middleRadius + num3;
							connectPosition.m_LaneData.m_Flags = dedicatedLane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
							flag6 = num31 != laneCount || n >= targetBuffer.Length || roadPassThrough != RoadTypes.None;
						}
						else
						{
							num31 = math.min(laneCount - 1, n + math.max(0, laneCount - num7));
							falseValue = middleRadius + ((float)math.min(totalLaneCount - 1, n + math.max(0, totalLaneCount - num7)) + 0.5f) * spaceForLanes / (float)totalLaneCount;
							num32 = middleRadius + ((float)num31 + 0.5f) * spaceForLanes / (float)totalLaneCount;
							connectPosition.m_LaneData.m_Flags = lane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
							flag6 = n >= laneCount;
						}
						centerPosition.xz = middlePosition.xz + float5 * falseValue;
						connectPosition.m_Position.xz = middlePosition.xz + @float * num32;
						connectPosition.m_LaneData.m_Index = (byte)num31;
						if (flag)
						{
							connectPosition.m_LaneData.m_Flags |= LaneFlags.Slave;
						}
						...
						ConnectPosition targetPosition4 = targetBuffer[num30];
						...
						if ((sourcePosition4.m_RoadTypes & targetPosition4.m_RoadTypes) != RoadTypes.None)
						{
							flag8 |= (targetPosition4.m_LaneData.m_Flags & LaneFlags.Slave) != 0;
							CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition4, targetPosition4, intersectionFlags, laneGroup, (ushort)num29, flag6, isForbidden: false, isTemp, trackOnly: false, yield2, ownerTemp, isTurn: true, !m_LeftHandTraffic, isGentle: true, isUTurn: false, isRoundabout: true, a3, b3, flag6 && m_LeftHandTraffic, flag6 && !m_LeftHandTraffic, fixedTangents: true, roadPassThrough);
							isUnsafe = isUnsafe && flag6;
						}
						if (num30 < num5 || num30 >= num5 + num7 || n >= targetBuffer.Length)
						{
						...
						{
							num22 = math.max(num22, math.distance(MathUtils.Position(bezier4x3, 0.5f).xz, middlePosition.xz));
						}
					}
					if (flag8)
					{
						...
						float num33 = math.lerp(start2, end2, 0.5f);
						centerPosition.xz = middlePosition.xz + float5 * num33;
						float num34 = middleRadius + (float)laneCount * 0.5f * spaceForLanes / (float)totalLaneCount;
						connectPosition.m_Position.xz = middlePosition.xz + @float * num34;
						connectPosition.m_LaneData.m_Index = (byte)math.select(0, num13, flag);
						connectPosition.m_LaneData.m_Flags = lane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
						connectPosition.m_LaneData.m_Flags |= LaneFlags.Master;
						ConnectPosition sourcePosition5 = connectPosition;
						ConnectPosition targetPosition5 = nextMainPosition;
						PresetCurve(ref sourcePosition5, ref targetPosition5, middlePosition, centerPosition, float6, num33, num / (float)num2, 0f, 2f);
						curviness = -1f;
						CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition5, targetPosition5, intersectionFlags, laneGroup, 0, isUnsafe, isForbidden: false, isTemp, trackOnly: false, yield2, ownerTemp, isTurn: true, !m_LeftHandTraffic, isGentle: true, isUTurn: false, isRoundabout: true, isLeftLimit: false, isRightLimit: false, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
					}
					laneGroup++;
				}
				if (flag5)
				{
					...
					float num35 = middleRadius + ((float)totalLaneCount - 0.5f) * spaceForLanes / (float)totalLaneCount;
					num35 = math.lerp(num35, math.max(num35, num22), 0.5f);
					...
					int num36 = sourceBuffer.Length - 1;
					int valueToClamp = math.select(num36, sourceBuffer.Length - num36 - 1, m_LeftHandTraffic);
					valueToClamp = math.clamp(valueToClamp, num4, num4 + num6 - 1);
					int num37 = 0;
					int valueToClamp2 = math.select(num37, targetBuffer.Length - num37 - 1, m_LeftHandTraffic);
					valueToClamp2 = math.clamp(valueToClamp2, num5, num5 + num7 - 1);
					ConnectPosition connectPosition5 = sourceBuffer[valueToClamp];
					ConnectPosition connectPosition6 = targetBuffer[valueToClamp2];
					float t;
					float y = MathUtils.Distance(NetUtils.FitCurve(connectPosition5.m_Position, connectPosition5.m_Tangent, -connectPosition6.m_Tangent, connectPosition6.m_Position).xz, middlePosition.xz, out t);
					num35 = math.max(num35, y);
					float num38 = middleRadius + num3;
					bool flag11 = dedicatedLane.m_LaneData.m_Lane != Entity.Null && (sourceBuffer.Length > num6 || targetBuffer.Length > num7);
					if (flag11)
					{
						float num39 = 0.5f * spaceForLanes / (float)totalLaneCount + num3 - spaceForLanes;
						num35 = math.min(num35, num38 + 0.75f - num39);
						num38 = math.max(num38, num35 + num39);
					}
					ConnectPosition connectPosition7 = default(ConnectPosition);
					connectPosition7.m_LaneData.m_Lane = lane.m_LaneData.m_Lane;
					connectPosition7.m_NodeComposition = lane.m_NodeComposition;
					connectPosition7.m_EdgeComposition = lane.m_EdgeComposition;
					connectPosition7.m_CompositionData = lane.m_CompositionData;
					connectPosition7.m_Owner = owner;
					connectPosition7.m_CompositionData.m_SpeedLimit = math.lerp(connectPosition.m_CompositionData.m_SpeedLimit, connectPosition2.m_CompositionData.m_SpeedLimit, 0.5f);
					connectPosition7.m_BaseHeight = math.lerp(connectPosition.m_BaseHeight, connectPosition2.m_BaseHeight, 0.5f);
					connectPosition7.m_SegmentIndex = connectPosition2.m_SegmentIndex;
					connectPosition7.m_Tangent = float6;
					connectPosition7.m_Position.y = centerPosition.y;
					connectPosition7.m_LaneData.m_Index = (byte)(num14 + 1);
					connectPosition7.m_LaneData.m_Flags = lane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
					connectPosition7.m_Position.xz = middlePosition.xz + float5 * num35;
					connectPosition7.m_RoadTypes = lane.m_RoadTypes;
					ConnectPosition connectPosition8 = connectPosition7;
					connectPosition8.m_LaneData.m_Lane = dedicatedLane.m_LaneData.m_Lane;
					connectPosition8.m_LaneData.m_Index = (byte)(num14 + 2);
					connectPosition8.m_LaneData.m_Flags = dedicatedLane.m_LaneData.m_Flags & (LaneFlags.Road | LaneFlags.Track | LaneFlags.PublicOnly | LaneFlags.HasAuxiliary | LaneFlags.BicyclesOnly);
					connectPosition8.m_Position.xz = middlePosition.xz + float5 * num38;
					connectPosition8.m_RoadTypes = dedicatedLane.m_RoadTypes;
					float3 float9 = middlePosition;
					float9.y = math.lerp(connectPosition.m_Position.y, centerPosition.y, 0.5f);
					float9.xz += float7 * num35;
					float3 float10 = middlePosition;
					float10.y = math.lerp(centerPosition.y, connectPosition2.m_Position.y, 0.5f);
					float10.xz += float8 * num35;
					isSkipped = false;
					isUnsafe = true;
					bool isSkipped2 = false;
					int num40 = math.select(1, 2, (num6 < sourceBuffer.Length || flag11) && num7 != 0 && num6 != 0);
					int num41 = math.select(targetBuffer.Length, targetBuffer.Length + 1, flag11 && targetBuffer.Length == num7 && num6 != 0);
					int num42 = math.max(num40, num41);
					for (int num43 = 0; num43 < num42; num43++)
					{
						int num44 = math.select(num43, targetBuffer.Length - num43, m_LeftHandTraffic);
						num36 = math.select(sourceBuffer.Length - 1, sourceBuffer.Length - 2, num43 < num42 - 1 && sourceBuffer.Length > num6 && sourceBuffer.Length > 1);
						valueToClamp = math.select(num36, sourceBuffer.Length - num36 - 1, m_LeftHandTraffic);
						num37 = math.max(0, targetBuffer.Length - 1 - num43);
						valueToClamp2 = math.select(num37, targetBuffer.Length - num37 - 1, m_LeftHandTraffic);
						bool flag12 = valueToClamp < num4 || valueToClamp >= num4 + num6;
						bool flag13 = valueToClamp2 < num5 || valueToClamp2 >= num5 + num7;
						if (num42 - num43 <= num40)
						{
							bool a4 = false;
							bool b4 = true;
							if (m_LeftHandTraffic)
							...
							connectPosition5 = sourceBuffer[valueToClamp];
							connectPosition6 = connectPosition7;
							float3 centerPosition2 = float9;
							float middleOffset = num35;
							if (flag11 && (flag12 || flag13))
							{
								connectPosition6 = connectPosition8;
								centerPosition2.xz += float7 * (num38 - num35);
								middleOffset = num38;
							}
							if ((connectPosition5.m_RoadTypes & connectPosition6.m_RoadTypes) != RoadTypes.None)
							{
								flag9 |= (connectPosition5.m_LaneData.m_Flags & LaneFlags.Slave) != 0;
								connectPosition6.m_Tangent = -connectPosition6.m_Tangent;
								flag6 = flag11 && flag12 != flag13;
								isUnsafe = isUnsafe && flag6;
								PresetCurve(ref connectPosition5, ref connectPosition6, middlePosition, centerPosition2, centerTangent, middleOffset, 0f, num * 0.5f / (float)num2, 2f);
								curviness = -1f;
								CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, connectPosition5, connectPosition6, intersectionFlags, laneGroup, (ushort)num44, flag6, isForbidden: false, isTemp, trackOnly: false, yield3, ownerTemp, isTurn: true, !m_LeftHandTraffic, isGentle: false, isUTurn: false, isRoundabout: true, a4, b4, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
							}
						}
						if (num43 < num41)
						{
							bool a5 = false;
							bool b5 = num43 >= num7 - 1;
							if (m_LeftHandTraffic)
							{
								CommonUtils.Swap(ref a5, ref b5);
							}
							connectPosition5 = connectPosition7;
							connectPosition6 = targetBuffer[valueToClamp2];
							float3 centerPosition3 = float10;
							float middleOffset2 = num35;
							if (flag11 && (flag12 || flag13))
							{
								connectPosition5 = connectPosition8;
								centerPosition3.xz += float8 * (num38 - num35);
								middleOffset2 = num38;
							}
							if ((connectPosition5.m_RoadTypes & connectPosition6.m_RoadTypes) != RoadTypes.None)
							{
								flag10 |= (connectPosition6.m_LaneData.m_Flags & LaneFlags.Slave) != 0;
								PresetCurve(ref connectPosition5, ref connectPosition6, middlePosition, centerPosition3, centerTangent2, middleOffset2, num * 0.5f / (float)num2, 0f, 2f);
								flag6 = num37 > targetBuffer.Length - num7 || (flag11 && flag12 != flag13) || (!flag11 && flag13);
								isUnsafe = isUnsafe && flag6;
								curviness = -1f;
								CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped2, owner, laneBuffer, middleConnections, connectPosition5, connectPosition6, intersectionFlags, laneGroup + 1, (ushort)num44, flag6, isForbidden: false, isTemp, trackOnly: false, 0, ownerTemp, isTurn: true, !m_LeftHandTraffic, isGentle: false, isUTurn: false, isRoundabout: true, a5, b5, flag6 && !m_LeftHandTraffic, flag6 && m_LeftHandTraffic, fixedTangents: true, roadPassThrough);
							}
						}
					}
					if (flag9)
					{
						connectPosition5 = prevMainPosition;
						if (!flag10 && num7 == 0)
						{
							connectPosition6 = connectPosition8;
						...
						{
							connectPosition6 = connectPosition7;
							connectPosition6.m_LaneData.m_Index = (byte)math.select(num14 + 1, num14 + 3, flag10);
						}
						connectPosition6.m_Tangent = -connectPosition6.m_Tangent;
						PresetCurve(ref connectPosition5, ref connectPosition6, middlePosition, float9, centerTangent, num35, 0f, num * 0.5f / (float)num2, 2f);
						curviness = -1f;
						CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, connectPosition5, connectPosition6, intersectionFlags, laneGroup, 0, isUnsafe, isForbidden: false, isTemp, trackOnly: false, yield3, ownerTemp, isTurn: true, !m_LeftHandTraffic, isGentle: false, isUTurn: false, isRoundabout: true, isLeftLimit: false, isRightLimit: false, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
					}
					if (flag10)
					{
						if (!flag9 && num6 == 0)
						{
							connectPosition5 = connectPosition8;
							connectPosition5.m_LaneData.m_Index = (byte)(num14 + 2);
						}
						else
						{
							connectPosition5 = connectPosition7;
							connectPosition5.m_LaneData.m_Index = (byte)math.select(num14 + 1, num14 + 3, flag9);
						}
						connectPosition6 = nextMainPosition;
						PresetCurve(ref connectPosition5, ref connectPosition6, middlePosition, float10, centerTangent2, num35, num * 0.5f / (float)num2, 0f, 2f);
						curviness = -1f;
						CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped2, owner, laneBuffer, middleConnections, connectPosition5, connectPosition6, intersectionFlags, laneGroup + 1, 0, isUnsafe, isForbidden: false, isTemp, trackOnly: false, 0, ownerTemp, isTurn: true, !m_LeftHandTraffic, isGentle: false, isUTurn: false, isRoundabout: true, isLeftLimit: false, isRightLimit: false, isMergeLeft: false, isMergeRight: false, fixedTangents: true, roadPassThrough);
					}
					laneGroup += 2u;
				}
				@float = float4;
		...
		private bool GetRoundaboutLane(NativeList<ConnectPosition> buffer, float roundaboutSize, ref ConnectPosition roundaboutLane, ref ConnectPosition dedicatedLane, ref int laneCount, ref float laneWidth, ref bool isPublicOnly, ref float spaceForLanes, bool isSource, bool preferHighway, bool bicycleOnly)
		{
			bool flag = false;
			if (buffer.Length > 0)
			{
		...
		private void FillOldLaneBuffer(bool isEdge, bool isNode, Entity owner, DynamicBuffer<SubLane> lanes, NativeHashMap<LaneKey, Entity> laneBuffer)
		{
			StackList<PathNode> stackList = stackalloc PathNode[256];
			StackList<PathNode> stackList2 = stackalloc PathNode[256];
			StackList<bool> stackList3 = stackalloc bool[256];
			if (isNode)
			{
				...
				while (edgeIterator.GetNext(out value))
				{
					...
					for (int i = 0; i < bufferData.Length; i++)
					{
						...
						if ((bufferData[i].m_PathMethods & (PathMethod.Pedestrian | PathMethod.Road | PathMethod.Bicycle)) == 0 || m_SecondaryLaneData.HasComponent(subLane) || !m_EdgeLaneData.TryGetComponent(subLane, out var componentData))
						{
							continue;
						}
						bool2 x = componentData.m_EdgeDelta == num;
						if (math.any(x))
						{
			...
			for (int j = 0; j < lanes.Length; j++)
			{
				...
				if (isEdge)
				{
					if ((lanes[j].m_PathMethods & (PathMethod.Pedestrian | PathMethod.Road | PathMethod.Track | PathMethod.Bicycle)) != 0 && m_EdgeLaneData.TryGetComponent(subLane2, out var componentData2))
					{
		...
		private void CreateEdgeConnectionLanes(int jobIndex, ref int edgeLaneIndex, ref int connectionIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, NativeList<ConnectPosition> tempBuffer1, NativeList<ConnectPosition> tempBuffer2, Entity composition, EdgeGeometry geometryData, Curve curve, bool isSingleCurve, bool isTemp, Temp ownerTemp)
		{
			...
			for (int i = 0; i < sourceBuffer.Length; i++)
			{
				...
				if (num3 != -1)
				{
					...
					CreateCarEdgeConnections(jobIndex, ref edgeLaneIndex, ref random, owner, laneBuffer, geometryData, prefabCompositionData, compositionData, connectPosition, float2.xy, connectionIndex++, isSingleCurve, isSource: true, isTemp, ownerTemp, prefabCompositionLanes, num3);
				}
			}
			num = -1;
			for (int j = 0; j < targetBuffer.Length; j++)
			{
				...
				if (num6 != -1)
				{
					...
					CreateCarEdgeConnections(jobIndex, ref edgeLaneIndex, ref random, owner, laneBuffer, geometryData, prefabCompositionData, compositionData, connectPosition2, float4.xy, connectionIndex++, isSingleCurve, isSource: false, isTemp, ownerTemp, prefabCompositionLanes, num6);
				}
			}
		...
		private void FindAnchors(Entity node, NativeList<LaneAnchor> anchors, NativeList<LaneAnchor> tempBuffer)
		{
			...
			while (num < anchors.Length && num2 < tempBuffer.Length)
			{
				...
				float3 @float = laneAnchor.m_Position;
				float3 float2 = laneAnchor.m_Position;
				int j;
				for (j = num + 1; j < anchors.Length; j++)
				{
					...
					@float += laneAnchor3.m_Position;
					float2 = laneAnchor3.m_Position;
				}
				@float /= (float)(j - num);
				int k;
				...
				if (num4 > num3)
				{
					for (int l = num2; l < k; l++)
					{
						...
						value.m_Order = value.m_Order * 10000f + math.distance(value.m_Position, @float);
						tempBuffer[l] = value;
					}
				...
				if (num4 > 1)
				{
					float3 y = float2 - laneAnchor.m_Position;
					int num5 = num2 + num4;
					for (int m = num2; m < num5; m++)
					{
						LaneAnchor value2 = tempBuffer[m];
						value2.m_Order = math.dot(value2.m_Position - @float, y);
						tempBuffer[m] = value2;
					}
					tempBuffer.AsArray().GetSubArray(num2, num4).Sort();
					...
					while (num7 < num5)
					{
						...
						if (n > num7 + 1)
						{
							...
							for (int num8 = num7; num8 < n; num8++)
							{
								...
								value3.m_Order = math.dot(value3.m_Position - @float, y);
		...
		private void CreateEdgeLanes(int jobIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, Composition composition, Edge edge, EdgeGeometry geometryData, Segment combinedSegment, bool isSingleCurve, bool isTemp, Temp ownerTemp)
		{
			...
			for (int i = 0; i < prefabCompositionLanes.Length; i++)
			{
				...
				if ((netCompositionLane.m_Flags & LaneFlags.FindAnchor) != 0)
				{
					...
					LaneAnchor value2 = new LaneAnchor
					{
						m_Prefab = netCompositionLane.m_Lane,
						m_Order = i,
			...
			if (isSingleCurve)
			{
				for (int j = 0; j < prefabCompositionLanes.Length; j++)
				{
					...
					CreateEdgeLane(jobIndex, ref random, owner, laneBuffer, combinedSegment, prefabCompositionData, compositionData, prefabCompositionLanes, prefabCompositionLaneData, new int2(0, 4), new float2(0f, 1f), nativeList, nativeList2, true, isTemp, ownerTemp);
				}
			}
			else
			{
		...
		private int FindBestConnectionLane(DynamicBuffer<NetCompositionLane> prefabCompositionLanes, float2 offset, float elevationOffset, LaneFlags laneType, LaneFlags laneFlags)
		{
			...
			for (int i = 0; i < prefabCompositionLanes.Length; i++)
			{
				...
				float2 @float = new float2(offset.y, elevationOffset);
				@float = math.abs(@float - netCompositionLane.m_Position.yy);
				float num2 = math.lengthsq(new float2(netCompositionLane.m_Position.x - offset.x, math.cmin(@float)));
				if (num2 < num)
				{
					num = num2;
					result = i;
		...
		private void CreateCarEdgeConnections(int jobIndex, ref int edgeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, EdgeGeometry geometryData, NetCompositionData prefabCompositionData, CompositionData compositionData, ConnectPosition connectPosition, float2 offset, int connectionIndex, bool isSingleCurve, bool isSource, bool isTemp, Temp ownerTemp, DynamicBuffer<NetCompositionLane> prefabCompositionLanes, int bestIndex)
		{
		...
		private void CreateNodeConnectionLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, NativeList<MiddleConnection> middleConnections, NativeList<ConnectPosition> tempBuffer, CompositionFlags intersectionFlags, bool isRoundabout, bool isTemp, Temp ownerTemp)
		{
			int num = 0;
				...
				else
				{
					...
					for (int l = num5; l <= j; l++)
					{
						...
						for (int m = num5; m <= j; m++)
						{
							...
							if ((middleConnection5.m_TargetFlags & LaneFlags.Master) == 0 && middleConnection5.m_Distance < middleConnection.m_Distance && ((middleConnection5.m_TargetGroup ^ middleConnection.m_TargetGroup) & (uint)(middleConnection.m_IsSource ? (-65536) : 65535)) == 0)
							{
					...
					for (int n = num5; n <= j; n++)
					{
						...
						if (flag && (middleConnection.m_TargetFlags & LaneFlags.Master) != 0)
						{
							...
							for (int num6 = num5; num6 <= j; num6++)
							{
								...
								if ((middleConnection6.m_TargetFlags & LaneFlags.Master) == 0 && middleConnection6.m_TargetGroup == middleConnection.m_TargetGroup && middleConnection6.m_TargetCarriageway == num3 && middleConnection6.m_Distance < float.MaxValue && (!isRoundabout || (middleConnection6.m_TargetOwner == entity && (entity != owner || middleConnection6.m_TargetGroup == num4))))
								{
									flag = true;
									break;
								}
						...
						if (flag && (middleConnection.m_TargetFlags & LaneFlags.Master) != 0)
						{
							uint num7 = (middleConnection.m_IsSource ? (middleConnection.m_ConnectPosition.m_GroupIndex | (middleConnection.m_TargetGroup & 0xFFFF0000u)) : ((middleConnection.m_TargetGroup & 0xFFFF) | (uint)(middleConnection.m_ConnectPosition.m_GroupIndex << 16)));
		...
		private void CreateNodeConnectionLane(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, MiddleConnection middleConnection, CompositionFlags intersectionFlags, bool useGroundPosition, bool isTemp, Temp ownerTemp)
		{
			Owner component = new Owner
			{
				m_Owner = owner
			};
			...
			{
				if (m_NetLaneData.TryGetComponent(middleConnection.m_TargetLane, out var componentData))
				{
					component3.m_WidthOffset.x = componentData.m_Width - netLaneData.m_Width;
				}
				if (m_NetLaneData.TryGetComponent(middleConnection.m_ConnectPosition.m_LaneData.m_Lane, out var componentData2))
				{
				...
				component3.m_Flags |= ((component3.m_WidthOffset.x != 0f) ? NodeLaneFlags.StartWidthOffset : ((NodeLaneFlags)0));
			...
			if ((middleConnection.m_ConnectPosition.m_LaneData.m_Flags & LaneFlags.Utility) != 0)
			{
				...
				if (m_PrefabRefData.TryGetComponent(middleConnection.m_ConnectPosition.m_Owner, out var componentData3) && m_PrefabNetData.TryGetComponent(componentData3.m_Prefab, out var componentData4) && m_PrefabGeometryData.TryGetComponent(componentData3.m_Prefab, out var componentData5) && (componentData4.m_RequiredLayers & (Layer.PowerlineLow | Layer.PowerlineHigh | Layer.WaterPipe | Layer.SewagePipe)) != Layer.None && (componentData5.m_Flags & GeometryFlags.Marker) == 0)
				{
			...
			if (laneBuffer.m_OldLanes.TryGetValue(laneKey, out var item))
			{
				...
				{
					MasterLane component6 = new MasterLane
					{
						m_Group = num
					};
			...
			else
			{
				...
				if ((middleConnection.m_ConnectPosition.m_LaneData.m_Flags & LaneFlags.Master) != 0)
				{
					MasterLane component8 = new MasterLane
					{
						m_Group = num
					};
		...
		private void CreateEdgeConnectionLane(int jobIndex, ref int edgeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, Segment startSegment, Segment endSegment, NetCompositionData prefabCompositionData, CompositionData compositionData, NetCompositionLane prefabCompositionLaneData, ConnectPosition connectPosition, int connectionIndex, bool isSingleCurve, bool useGroundPosition, bool isSource, bool isTemp, Temp ownerTemp)
		{
			...
			{
				if (m_NetLaneData.TryGetComponent(prefabCompositionLaneData.m_Lane, out var componentData))
				{
					component3.m_WidthOffset.x = componentData.m_Width - netLaneData.m_Width;
				}
				if (m_NetLaneData.TryGetComponent(connectPosition.m_LaneData.m_Lane, out var componentData2))
				{
					component3.m_WidthOffset.y = componentData2.m_Width - netLaneData.m_Width;
				}
				if (isSource)
			...
			if ((connectPosition.m_LaneData.m_Flags & LaneFlags.Utility) != 0)
			{
				...
				if (m_PrefabRefData.TryGetComponent(connectPosition.m_Owner, out var componentData3) && m_PrefabNetData.TryGetComponent(componentData3.m_Prefab, out var componentData4) && m_PrefabGeometryData.TryGetComponent(componentData3.m_Prefab, out var componentData5) && (componentData4.m_RequiredLayers & (Layer.PowerlineLow | Layer.PowerlineHigh | Layer.WaterPipe | Layer.SewagePipe)) != Layer.None && (componentData5.m_Flags & GeometryFlags.Marker) == 0)
				{
					component6.m_Flags |= UtilityLaneFlags.PipelineConnection;
				}
			}
			uint num3 = (uint)(prefabCompositionLaneData.m_Group | (connectionIndex + 4 << 8));
			...
			if (laneBuffer.m_OldLanes.TryGetValue(laneKey, out var item))
			{
				...
				if ((connectPosition.m_LaneData.m_Flags & LaneFlags.Master) != 0)
				{
					MasterLane component7 = new MasterLane
					{
						m_Group = num3
					};
					m_CommandBuffer.SetComponent(jobIndex, item, component7);
			...
			else
			{
				...
				if ((connectPosition.m_LaneData.m_Flags & LaneFlags.Master) != 0)
				{
					MasterLane component9 = new MasterLane
					{
						m_Group = num3
					};
					m_CommandBuffer.SetComponent(jobIndex, e, component9);
		...
		private void CreateEdgeLane(int jobIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, Segment segment, NetCompositionData prefabCompositionData, CompositionData compositionData, DynamicBuffer<NetCompositionLane> prefabCompositionLanes, NetCompositionLane prefabCompositionLaneData, int2 segmentIndex, float2 edgeDelta, NativeList<LaneAnchor> startAnchors, NativeList<LaneAnchor> endAnchors, bool2 canAnchor, bool isTemp, Temp ownerTemp)
		{
			...
			{
				m_Bezier = MathUtils.Lerp(segment.m_Left, segment.m_Right, t)
			};
			...
			if ((laneFlags & LaneFlags.Parking) != 0)
			{
				...
				if (m_ParkingLaneData.TryGetComponent(component2.m_Prefab, out var componentData) && (componentData.m_RoadTypes & ~RoadTypes.Bicycle) != RoadTypes.None)
				{
				...
				if (netCompositionLane.m_Lane != Entity.Null)
				{
					...
					if ((laneFlags & LaneFlags.Twoway) != 0)
					{
						NetCompositionLane netCompositionLane3 = FindClosestLane(prefabCompositionLanes, LaneFlags.Road | (~netCompositionLane.m_Flags & LaneFlags.Invert), laneFlags2 | (netCompositionLane.m_Flags & LaneFlags.Invert), netCompositionLane.m_Position, netCompositionLane.m_Carriageway);
			...
			if ((laneFlags & LaneFlags.Pedestrian) != 0)
			{
				...
				if ((prefabCompositionData.m_State & (CompositionState.HasForwardRoadLanes | CompositionState.HasBackwardRoadLanes | CompositionState.HasForwardTrackLanes | CompositionState.HasBackwardTrackLanes)) == 0 && m_PedestrianLaneData.TryGetComponent(prefabCompositionLaneData.m_Lane, out var componentData2) && componentData2.m_NotWalkLanePrefab != Entity.Null)
				{
					Entity entity = owner;
			...
			uint num3 = (uint)(prefabCompositionLaneData.m_Group | (segmentIndex.x << 8));
			...
			if ((laneFlags & LaneFlags.Master) != 0)
			{
				MasterLane component11 = new MasterLane
				{
					m_Group = num3
				};
			...
			if ((laneFlags & LaneFlags.Slave) != 0)
			{
				SlaveLane component12 = new SlaveLane
				{
					m_Group = num3,
					m_MinIndex = prefabCompositionLaneData.m_Index,
					m_MaxIndex = prefabCompositionLaneData.m_Index,
		...
		private void GetMiddleConnections(Entity owner, Entity original, NativeList<MiddleConnection> middleConnections, NativeList<EdgeTarget> tempEdgeTargets, NativeList<ConnectPosition> tempBuffer1, NativeList<ConnectPosition> tempBuffer2, ref int groupIndex)
		{
			...
			for (int i = 0; i < list.Length; i++)
			{
				...
				for (int j = 0; j < dynamicBuffer.Length; j++)
				{
					...
					GetNodeConnectPositions(connectedNode.m_Node, connectedNode.m_CurvePosition, tempBuffer1, tempBuffer2, includeAnchored: true, ref groupIndex2, out var _, out var _, out var _);
		...
		private RoadTypes GetRoundaboutRoadPassThrough(Entity owner)
		{
			...
			if (m_SubObjects.TryGetBuffer(owner, out var bufferData))
			{
				for (int i = 0; i < bufferData.Length; i++)
				{
					if (m_PrefabRefData.TryGetComponent(bufferData[i].m_SubObject, out var componentData) && m_PrefabNetObjectData.TryGetComponent(componentData.m_Prefab, out var componentData2) && (componentData2.m_CompositionFlags.m_General & CompositionFlags.General.Roundabout) != 0)
					{
		...
		private void GetNodeConnectPositions(Entity owner, float curvePosition, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, bool includeAnchored, ref int groupIndex, out float middleRadius, out float roundaboutSize, out CompositionFlags intersectionFlags)
		{
			middleRadius = 0f;
			roundaboutSize = 0f;
		...
		private unsafe void GetNodeConnectPositions(Entity node, Entity edge, bool isEnd, int groupIndex, float curvePosition, float2 elevation, NetGeometryData prefabGeometryData, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, bool includeAnchored, ref float middleRadius, ref float roundaboutSize, ref CompositionFlags intersectionFlags, ref NativeParallelHashSet<Entity> anchorPrefabs)
		{
			...
			float2 @float = NetCompositionHelpers.CalculateRoundaboutSize(pieces: m_PrefabCompositionPieces[composition.m_Edge], compositionData: compositionData2);
			...
			intersectionFlags |= compositionData2.m_Flags;
			...
			if (!m_UpdatedData.HasComponent(edge) && m_SubLanes.HasBuffer(edge))
			{
				...
				for (int j = 0; j < dynamicBuffer2.Length; j++)
				{
					...
					{
						targetBuffer.Add(in value);
						if (value.m_RoadTypes != RoadTypes.None)
						{
							sourceBuffer.Add(in value);
						}
					}
			...
			for (int l = 0; l < dynamicBuffer.Length; l++)
			{
				...
				if (((uint)laneData2.m_Flags & (uint)(flag2 ? 512 : 256)) != 0 || ((laneData2.m_Flags & laneFlags) != 0 && IsAnchored(node, ref anchorPrefabs, laneData2.m_Lane)))
				{
					continue;
				}
				...
				ConnectPosition value2 = new ConnectPosition
				{
				...
				if ((laneData2.m_Flags & (LaneFlags.Pedestrian | LaneFlags.Utility)) != 0)
				{
					...
					if (value2.m_RoadTypes != RoadTypes.None)
					{
		...
		private void FilterMainCarConnectPositions(NativeList<ConnectPosition> input, NativeList<ConnectPosition> output)
		{
			...
			for (int i = 0; i < input.Length; i++)
			{
				...
				else if ((value.m_LaneData.m_Flags & LaneFlags.Pedestrian) != 0 && value.m_RoadTypes != RoadTypes.None)
				{
					output.Add(in value);
				}
			}
		...
		private void FilterActualCarConnectPositions(RoadTypes roadTypes, NativeList<ConnectPosition> input, NativeList<ConnectPosition> output)
		{
			...
			{
				ConnectPosition value = input[i];
				if (((value.m_LaneData.m_Flags & (LaneFlags.Master | LaneFlags.Road)) == LaneFlags.Road || (value.m_LaneData.m_Flags & LaneFlags.Pedestrian) != 0) && (value.m_RoadTypes & roadTypes) != RoadTypes.None)
				{
					output.Add(in value);
				}
			}
		...
		private void FilterActualCarConnectPositions(ConnectPosition main, NativeList<ConnectPosition> input, NativeList<ConnectPosition> output)
		{
			...
			{
				ConnectPosition value = input[i];
				if (((value.m_LaneData.m_Flags & (LaneFlags.Master | LaneFlags.Road)) == LaneFlags.Road || (value.m_LaneData.m_Flags & LaneFlags.Pedestrian) != 0) && value.m_Owner == main.m_Owner && value.m_LaneData.m_Group == main.m_LaneData.m_Group)
				{
					output.Add(in value);
				}
			}
		...
		private void FilterTrackConnectPositions(ref int index, TrackTypes trackType, NativeList<ConnectPosition> input, NativeList<ConnectPosition> output)
		{
			...
			{
				value = input[index++];
				if ((value.m_TrackTypes & trackType) != TrackTypes.None)
				{
					output.Add(in value);
					break;
				}
			...
			while (index < input.Length)
			{
				...
				{
					if ((value2.m_TrackTypes & trackType) != TrackTypes.None)
					{
		...
		private void FilterUtilityConnectPositions(UtilityTypes utilityTypes, NativeList<ConnectPosition> input, NativeList<ConnectPosition> output)
		{
			...
			{
				ConnectPosition value = input[i];
				if ((value.m_UtilityTypes & utilityTypes) != UtilityTypes.None)
				{
					output.Add(in value);
				}
			}
		...
		private void ProcessCarConnectPositions(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, Entity prefab, LaneBuffer laneBuffer, NativeList<MiddleConnection> middleConnections, NativeParallelHashSet<ConnectionKey> createdConnections, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, NativeList<ConnectPosition> allSources, RoadTypes roadPassThrough, CompositionFlags intersectionFlags, bool isTemp, Temp ownerTemp, int yield)
		{
			if (sourceBuffer.Length >= 1 && targetBuffer.Length >= 1)
			{
				...
				CreateNodeCarLanes(jobIndex, ref nodeLaneIndex, ref random, owner, prefab, laneBuffer, middleConnections, createdConnections, sourceBuffer, targetBuffer, allSources, roadPassThrough, intersectionFlags, isTemp, ownerTemp, yield);
			}
		}
		...
		private int2 CalculateSourcesBetween(ConnectPosition source, ConnectPosition target, NativeList<ConnectPosition> allSources)
		{
			...
			for (int i = 0; i < allSources.Length; i++)
			{
				...
				if (sourcePosition.m_GroupIndex != source.m_GroupIndex && (sourcePosition.m_LaneData.m_Flags & (LaneFlags.Master | LaneFlags.Road)) == LaneFlags.Road && ((sourcePosition.m_RoadTypes & source.m_RoadTypes & ~RoadTypes.Bicycle) != RoadTypes.None || (sourcePosition.m_RoadTypes == RoadTypes.Bicycle && source.m_RoadTypes == RoadTypes.Bicycle)) && !(IsTurn(sourcePosition, target, out var _, out var _, out var uturn) && uturn))
				{
		...
		private void CreateNodeCarLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, Entity prefab, LaneBuffer laneBuffer, NativeList<MiddleConnection> middleConnections, NativeParallelHashSet<ConnectionKey> createdConnections, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, NativeList<ConnectPosition> allSources, RoadTypes roadPassThrough, CompositionFlags intersectionFlags, bool isTemp, Temp ownerTemp, int yield)
		{
			...
			for (int i = 0; i < sourceBuffer.Length; i++)
			{
				roadTypes |= sourceBuffer[i].m_RoadTypes;
			}
			for (int j = 0; j < targetBuffer.Length; j++)
			{
				roadTypes |= targetBuffer[j].m_RoadTypes;
			}
			RoadTypes roadTypes2 = ((((uint)roadTypes & (uint)(byte)(~(int)sourcePosition.m_RoadTypes)) != 0) ? sourcePosition.m_RoadTypes : RoadTypes.None);
			RoadTypes roadTypes3 = ((((uint)roadTypes & (uint)(byte)(~(int)sourcePosition2.m_RoadTypes)) != 0) ? sourcePosition2.m_RoadTypes : RoadTypes.None);
			if (roadTypes2 == RoadTypes.Car)
			{
				roadTypes2 = RoadTypes.None;
			}
			if (roadTypes3 == RoadTypes.Car)
			{
				roadTypes3 = RoadTypes.None;
			}
			int k;
			for (k = 0; k < sourceBuffer.Length && sourceBuffer[k].m_RoadTypes == roadTypes2; k++)
			{
			}
			int l;
			for (l = 0; l < sourceBuffer.Length && sourceBuffer[sourceBuffer.Length - 1 - l].m_RoadTypes == roadTypes3; l++)
			{
			}
			...
			while (num5 < targetBuffer.Length)
			{
				...
				int m;
				for (m = num5 + 1; m < targetBuffer.Length && targetBuffer[m].m_GroupIndex == connectPosition.m_GroupIndex; m++)
				{
				}
				ConnectPosition connectPosition2 = targetBuffer[m - 1];
				int n = 0;
				int num6 = 0;
				RoadTypes roadTypes4 = ((((uint)roadTypes & (uint)(byte)(~(int)connectPosition.m_RoadTypes)) != 0) ? connectPosition.m_RoadTypes : RoadTypes.None);
				RoadTypes roadTypes5 = ((((uint)roadTypes & (uint)(byte)(~(int)connectPosition2.m_RoadTypes)) != 0) ? connectPosition2.m_RoadTypes : RoadTypes.None);
			...
			NetGeometryData netGeometryData2 = m_PrefabGeometryData[m_PrefabRefData[sourcePosition.m_Owner]];
			NetCompositionData netCompositionData = m_PrefabCompositionData[sourcePosition.m_NodeComposition];
			CompositionFlags.Side num9 = (((netCompositionData.m_Flags.m_General & CompositionFlags.General.Invert) != 0 != ((sourcePosition.m_LaneData.m_Flags & LaneFlags.Invert) != 0)) ? netCompositionData.m_Flags.m_Left : netCompositionData.m_Flags.m_Right);
			bool flag = (num9 & CompositionFlags.Side.ForbidLeftTurn) != 0;
			bool flag2 = (num9 & CompositionFlags.Side.ForbidRightTurn) != 0;
			bool test = (num9 & CompositionFlags.Side.ForbidStraight) != 0;
			int num10 = 0;
			int num11 = 0;
			int num12 = 0;
			...
			while (num10 + num18 < stackList.Length - num14)
			{
				...
				if (!IsTurn(sourcePosition, targetPosition3, out var right3, out var gentle3, out var _) || right3)
				{
					break;
				}
				if (gentle3)
			...
			while (num14 + num22 < stackList.Length - num10 - num18)
			{
				...
				if (!IsTurn(sourcePosition2, targetPosition4, out var right4, out var gentle4, out var _) || !right4)
				{
					break;
				}
				if (gentle4)
			...
			int num30 = math.select(0, num29, test);
			...
			{
				num61 = stackList[stackList.Length - 1];
			}
			...
			for (int num63 = 0; num63 < k; num63++)
			{
				...
				while (num65 < num67 || num66 < num68)
				{
					...
					if ((!flag3 || num64 < num2 || num64 >= num2 + num) && (sourcePosition3.m_RoadTypes & targetPosition5.m_RoadTypes) != RoadTypes.None)
					{
						...
						uint num72 = (uint)(sourcePosition3.m_GroupIndex | (targetPosition5.m_GroupIndex << 16));
						...
						if (CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition3, targetPosition5, intersectionFlags, num72, 0, flag4, isForbidden: false, isTemp, trackOnly: false, yield, ownerTemp, isTurn, right5, gentle5, uturn5, isRoundabout: false, isLeftLimit, isRightLimit, isMergeLeft: false, isMergeRight: false, fixedTangents: false, roadPassThrough))
						{
			...
			for (int num73 = 0; num73 < l; num73++)
			{
				int num74 = sourceBuffer.Length - l + num73;
				ConnectPosition sourcePosition4 = sourceBuffer[num74];
				int num75 = num59;
				int num76;
				for (num76 = 0; num76 < stackList2.Length && stackList2[num76] < num61; num76++)
				{
				}
				while (num75 < stackList.Length || num76 < stackList2.Length)
				{
					int num77;
					ConnectPosition targetPosition6;
					bool flag5;
					if (num75 < stackList.Length)
					{
						num77 = stackList[num75++];
						targetPosition6 = targetBuffer[num77];
						flag5 = true;
						for (; num75 < stackList.Length; num75++)
						{
							ConnectPosition connectPosition8 = targetBuffer[stackList[num75]];
						...
						if (num76 < stackList2.Length)
						{
							int num78 = stackList2[num76];
							ConnectPosition connectPosition9 = targetBuffer[num78];
							if (num78 < num77 || targetPosition6.m_GroupIndex == connectPosition9.m_GroupIndex)
							{
								targetPosition6 = connectPosition9;
								num77 = num78;
								num75 -= math.select(0, 1, targetPosition6.m_GroupIndex != connectPosition9.m_GroupIndex);
								num76++;
								flag5 = false;
							}
						}
					...
					{
						num77 = stackList2[num76++];
						targetPosition6 = targetBuffer[num77];
						flag5 = false;
					}
					if ((!flag5 || num74 < num2 || num74 >= num2 + num) && (sourcePosition4.m_RoadTypes & targetPosition6.m_RoadTypes) != RoadTypes.None)
					{
						...
						uint num79 = (uint)(sourcePosition4.m_GroupIndex | (targetPosition6.m_GroupIndex << 16));
						bool isLeftLimit2 = num74 == 0 && num77 == 0;
						bool isRightLimit2 = (num74 == sourceBuffer.Length - 1) & (num77 == targetBuffer.Length - 1);
						float curviness2 = -1f;
						bool isSkipped2 = false;
						...
						if (CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness2, ref isSkipped2, owner, laneBuffer, middleConnections, sourcePosition4, targetPosition6, intersectionFlags, num79, 16383, flag6, isForbidden: false, isTemp, trackOnly: false, yield, ownerTemp, isTurn2, right6, gentle6, uturn6, isRoundabout: false, isLeftLimit2, isRightLimit2, isMergeLeft: false, isMergeRight: false, fixedTangents: false, roadPassThrough))
						{
			...
			int num80 = 0;
			while (num80 < stackList.Length)
			{
				ConnectPosition connectPosition10 = targetBuffer[stackList[num80]];
				ConnectPosition targetPosition7 = connectPosition10;
				int num81;
				for (num81 = num80 + 1; num81 < stackList.Length; num81++)
				{
					ConnectPosition connectPosition11 = targetBuffer[stackList[num81]];
				...
				int num82 = num81 - num80;
				int num83 = stackList.Length - num81;
				uint num84 = (uint)(sourcePosition.m_GroupIndex | (connectPosition10.m_GroupIndex << 16));
				bool flag7 = num80 < num10 + num18 || num83 < num14 + num22;
				bool flag8 = num80 < num10 || num83 < num14;
				bool flag9 = num80 < num11 || num83 < num15;
				bool flag10 = num80 < num12 + num20 || num83 < num16 + num24;
				bool flag11 = num83 < num14 + num22;
				bool isGentle = false;
				int num85;
				int num86;
				if (flag7)
				{
					...
					if (flag8)
					{
						if (flag11)
						{
							num85 = (num83 * num56 + math.select(0, num14 - 1, num56 > num14)) / num14;
							num86 = ((num83 + num82) * num56 + num14 - 1) / num14 - 1;
							num85 = num - num85 - 1;
							num86 = num - num86 - 1;
							CommonUtils.Swap(ref num85, ref num86);
						}
						else
						{
							int num87 = num80;
							num85 = (num87 * num55 + math.select(0, num10 - 1, num55 > num10)) / num10;
							num86 = ((num87 + num82) * num55 + num10 - 1) / num10 - 1;
						}
					}
					else if (flag11)
					{
						int num88 = num83 - num14;
						num85 = (num88 * num58 + math.select(0, num22 - 1, num58 > num22)) / num22;
						num86 = ((num88 + num82) * num58 + num22 - 1) / num22 - 1;
						num85 = num - num41 - num85 - 1;
						num86 = num - num41 - num86 - 1;
						CommonUtils.Swap(ref num85, ref num86);
						IsTurn(sourceBuffer[num85 + num2], connectPosition10, out right7, out var gentle7, out uturn7);
						IsTurn(sourceBuffer[num86 + num2], targetPosition7, out uturn7, out var gentle8, out right7);
						isGentle = gentle7 && gentle8;
					}
					else
					{
						int num89 = num80 - num10;
						num85 = (num89 * num57 + math.select(0, num18 - 1, num57 > num18)) / num18;
						num86 = ((num89 + num82) * num57 + num18 - 1) / num18 - 1;
						num85 = num40 + num85;
						num86 = num40 + num86;
						IsTurn(sourceBuffer[num85 + num2], connectPosition10, out right7, out var gentle9, out uturn7);
						IsTurn(sourceBuffer[num86 + num2], targetPosition7, out uturn7, out var gentle10, out right7);
						isGentle = gentle9 && gentle10;
					}
				}
				else
				{
					int num90 = num80 - num10 - num18;
					if (num42 == 0)
					{
						num85 = ((!m_LeftHandTraffic) ? math.min(num40 + num45, num - 1) : math.max(num40 + num45 - 1, 0));
						num86 = num85;
					}
					else
					{
						num85 = (num90 * num42 + math.select(0, num29 - 1, num42 > num29)) / num29;
						num86 = ((num90 + num82) * num42 + num29 - 1) / num29 - 1;
						num85 = num40 + num45 + num85;
						num86 = num40 + num45 + num86;
					}
					if (num30 > 0)
					{
						flag10 = ((!m_LeftHandTraffic) ? (flag10 || num29 - num90 - 1 < num30) : (flag10 || num90 < num30));
					}
				}
				int num91 = num86 - num85 + 1;
				int num92 = math.max(num91, num82);
				int num93 = math.min(num91, num82);
				int num94 = 0;
				int num95 = num92 - num93;
				int num96 = 0;
				int num97 = 0;
				float num98 = float.MaxValue;
				int2 @int = 0;
				if (num82 > num91)
				{
					@int = CalculateSourcesBetween(sourceBuffer[num85 + num2], targetBuffer[stackList[num80]], allSources);
					if (math.any(@int >= 1))
					{
						int num99 = math.csum(@int);
						int num100;
						int num101;
						if (num99 > num95)
						{
							num100 = @int.x * num95 / num99;
							num101 = @int.y * num95 / num99;
							if ((num95 >= 2) & math.all(@int >= 1))
							{
								num100 = math.max(num100, 1);
								num101 = math.max(num101, 1);
							}
						}
						else
						{
				...
				for (int num102 = num94; num102 <= num95; num102++)
				{
					int num103 = math.max(num102 + num91 - num92, 0);
					int num104 = math.max(num102 + num82 - num92, 0);
					num103 += num85;
					num104 += num80;
					ConnectPosition connectPosition12 = sourceBuffer[num103 + num2];
					ConnectPosition connectPosition13 = sourceBuffer[num103 + num2 + num93 - 1];
					ConnectPosition connectPosition14 = targetBuffer[stackList[num104]];
					ConnectPosition connectPosition15 = targetBuffer[stackList[num104 + num93 - 1]];
					float num105 = math.max(0f, math.dot(connectPosition12.m_Tangent, connectPosition14.m_Tangent) * -0.5f);
					float num106 = math.max(0f, math.dot(connectPosition13.m_Tangent, connectPosition15.m_Tangent) * -0.5f);
					num105 *= math.distance(connectPosition12.m_Position.xz, connectPosition14.m_Position.xz);
					num106 *= math.distance(connectPosition13.m_Position.xz, connectPosition15.m_Position.xz);
					connectPosition12.m_Position.xz += connectPosition12.m_Tangent.xz * num105;
					connectPosition14.m_Position.xz += connectPosition14.m_Tangent.xz * num105;
					connectPosition13.m_Position.xz += connectPosition13.m_Tangent.xz * num106;
					connectPosition15.m_Position.xz += connectPosition15.m_Tangent.xz * num106;
					...
					float num107 = math.max(x, y);
					if (num107 < num98)
					{
						num96 = math.min(num92 - num82 - num102, 0);
						num97 = math.min(num92 - num91 - num102, 0);
						num98 = num107;
					}
				}
				for (int num108 = 0; num108 < num92; num108++)
				{
					int num109 = math.clamp(num108 + num96, 0, num91 - 1);
					int num110 = math.clamp(num108 + num97, 0, num82 - 1);
					bool flag12 = num108 + num96 < 0;
					bool flag13 = num108 + num96 >= num91;
					bool flag14 = num108 + num97 < 0;
					bool flag15 = num108 + num97 >= num82;
					bool flag16 = flag12 || flag14;
					bool flag17 = flag13 || flag15;
					bool flag18 = ((!flag7) ? (flag16 || flag17 || flag10) : ((!flag11) ? (flag16 || flag17 || flag9 || flag10 || (flag8 && num40 == 0)) : (flag16 || flag17 || flag9 || flag10 || (flag8 && num41 == 0))));
					num109 += num85;
					num110 += num80;
					int num111 = stackList[num110];
					bool isLeftLimit3 = num109 == 0 && num110 == num3;
					bool isRightLimit3 = num109 == num - 1 && num110 == num4;
					ConnectPosition sourcePosition5 = sourceBuffer[num109 + num2];
					ConnectPosition connectPosition16 = targetBuffer[num111];
					...
					bool flag19 = ((uint)roadTypes & (uint)(byte)(~(int)sourcePosition5.m_RoadTypes)) != 0 && sourcePosition5.m_RoadTypes != RoadTypes.Car;
					bool flag20 = ((uint)roadTypes & (uint)(byte)(~(int)connectPosition16.m_RoadTypes)) != 0 && connectPosition16.m_RoadTypes != RoadTypes.Car;
					if (num108 == 0 || num108 == num92 - 1)
					{
						int num112 = math.select(1, 0, flag20);
						for (int num113 = 0; num113 < stackList2.Length; num113++)
						{
							int num114 = stackList2[num113];
							if (math.abs(num114 - num111) != num112 || (k != 0 && num114 <= num62) || (l != 0 && num114 >= num61))
							{
								continue;
							}
							ConnectPosition targetPosition8 = targetBuffer[num114];
							if (targetPosition8.m_GroupIndex == connectPosition16.m_GroupIndex && (sourcePosition5.m_RoadTypes & targetPosition8.m_RoadTypes) != RoadTypes.None)
							{
								int num115 = math.select(0, 16383, num114 > num111);
								bool isLeftLimit4 = num109 + num2 == 0 && num114 == 0;
								bool isRightLimit4 = (num109 + num2 == sourceBuffer.Length - 1) & (num114 == targetBuffer.Length - 1);
								float curviness3 = -1f;
								bool isSkipped3 = false;
								if (CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness3, ref isSkipped3, owner, laneBuffer, middleConnections, sourcePosition5, targetPosition8, intersectionFlags, num84, (ushort)num115, isUnsafe: true, flag10, isTemp, trackOnly: false, yield, ownerTemp, flag7, flag11, isGentle, flag8, isRoundabout: false, isLeftLimit4, isRightLimit4, isMergeLeft: false, isMergeRight: false, fixedTangents: false, roadPassThrough))
								{
					...
					if (!flag20 && (sourcePosition5.m_RoadTypes & connectPosition16.m_RoadTypes) != RoadTypes.None)
					{
						NetGeometryData netGeometryData5 = m_PrefabGeometryData[m_PrefabRefData[connectPosition16.m_Owner]];
						flag18 |= (netGeometryData.m_MergeLayers & netGeometryData2.m_MergeLayers & netGeometryData5.m_MergeLayers) == 0;
						flag18 = flag18 || flag19;
						float curviness4 = -1f;
						bool isSkipped4 = false;
						if (CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness4, ref isSkipped4, owner, laneBuffer, middleConnections, sourcePosition5, connectPosition16, intersectionFlags, num84, (ushort)(num108 + 1), flag18, flag10, isTemp, trackOnly: false, yield, ownerTemp, flag7, flag11, isGentle, flag8, isRoundabout: false, isLeftLimit3, isRightLimit3, flag16, flag17, fixedTangents: false, roadPassThrough))
						{
						...
						if (isSkipped4)
						{
							...
							targetBuffer[num111] = connectPosition16;
						}
						else if (flag10)
						{
						...
						else if (flag8 && (flag11 ? num41 : num40) == 0)
						{
							connectPosition16.m_UnsafeCount++;
							targetBuffer[num111] = connectPosition16;
						}
		...
		private void CreateNodeTrackLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, NativeList<MiddleConnection> middleConnections, NativeParallelHashSet<ConnectionKey> createdConnections, NativeList<ConnectPosition> sourceBuffer, NativeList<ConnectPosition> targetBuffer, bool isTemp, Temp ownerTemp)
		{
			...
			for (int k = 0; k < sourceBuffer.Length; k++)
			{
				...
				for (int l = 0; l < num2; l++)
				{
					...
					bool isSkipped = false;
					float curviness = -1f;
					CreateNodeLane(jobIndex, ref nodeLaneIndex, ref random, ref curviness, ref isSkipped, owner, laneBuffer, middleConnections, sourcePosition, targetPosition, default(CompositionFlags), 0u, 0, isUnsafe: false, isForbidden: false, isTemp, trackOnly: true, 0, ownerTemp, isTurn, right, gentle, uturn, isRoundabout: false, isLeftLimit, isRightLimit, isMergeLeft: false, isMergeRight: false, fixedTangents: false, RoadTypes.None);
				}
			}
		}
		...
		private bool CheckPrefab(ref Entity prefab, ref Unity.Mathematics.Random random, out Unity.Mathematics.Random outRandom, LaneBuffer laneBuffer)
		{
			if (!m_EditorMode)
			{
				if (m_PlaceholderObjects.TryGetBuffer(prefab, out var bufferData))
				{
					...
					for (int i = 0; i < bufferData.Length; i++)
					{
						Entity entity2 = bufferData[i].m_Object;
						float num3 = 0f;
						if (m_ObjectRequirements.TryGetBuffer(entity2, out var bufferData2))
						{
							int num4 = -1;
							bool flag = true;
						...
						SpawnableObjectData spawnableObjectData = m_PrefabSpawnableObjectData[entity2];
						Entity entity3 = ((spawnableObjectData.m_RandomizationGroup != Entity.Null) ? spawnableObjectData.m_RandomizationGroup : entity2);
						Unity.Mathematics.Random random3 = random;
						random.NextInt();
						random.NextInt();
						if (laneBuffer.m_SelectedSpawnables.TryGetValue(entity3, out var item))
						{
							num3 += 0.5f;
							random3 = item;
						}
		...
		private bool CreateNodeLane(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, ref float curviness, ref bool isSkipped, Entity owner, LaneBuffer laneBuffer, NativeList<MiddleConnection> middleConnections, ConnectPosition sourcePosition, ConnectPosition targetPosition, CompositionFlags intersectionFlags, uint group, ushort laneIndex, bool isUnsafe, bool isForbidden, bool isTemp, bool trackOnly, int yield, Temp ownerTemp, bool isTurn, bool isRight, bool isGentle, bool isUTurn, bool isRoundabout, bool isLeftLimit, bool isRightLimit, bool isMergeLeft, bool isMergeRight, bool fixedTangents, RoadTypes roadPassThrough)
		{
			NetCompositionData netCompositionData = m_PrefabCompositionData[sourcePosition.m_NodeComposition];
			...
			for (int i = 0; i <= num3; i++)
			{
				...
				if ((laneFlags & LaneFlags.Road) != 0)
				{
					if (m_NetLaneData.TryGetComponent(sourcePosition.m_LaneData.m_Lane, out var componentData))
					{
						component2.m_WidthOffset.x = componentData.m_Width - netLaneData.m_Width;
					}
					if (m_NetLaneData.TryGetComponent(targetPosition.m_LaneData.m_Lane, out var componentData2))
					{
						component2.m_WidthOffset.y = componentData2.m_Width - netLaneData.m_Width;
					}
					component2.m_Flags |= ((component2.m_WidthOffset.x != 0f) ? NodeLaneFlags.StartWidthOffset : ((NodeLaneFlags)0));
					...
					component2.m_Flags |= (NodeLaneFlags)(((componentData2.m_Flags & LaneFlags.BicyclesOnly) != 0) ? 8 : 0);
				}
				Curve curve = default(Curve);
				bool flag = false;
				...
				if ((laneFlags & LaneFlags.Road) != 0)
				{
					...
					else
					{
						...
						if (component5.m_Curviness > math.select(MathF.PI / 180f, MathF.PI / 360f, flag4))
						{
							component5.m_Flags |= CarLaneFlags.ForbidPassing;
						}
					}
				...
				if ((laneFlags & LaneFlags.Track) != 0)
				{
					...
					if (component6.m_Curviness > 1E-06f && m_TrackLaneData.TryGetComponent(prefabRef.m_Prefab, out var componentData3))
					{
						component6.m_Curviness = math.min(component6.m_Curviness, componentData3.m_MaxCurviness);
					}
					if ((sourcePosition.m_LaneData.m_Flags & targetPosition.m_LaneData.m_Flags & LaneFlags.Twoway) != 0)
					{
				...
				if ((component5.m_Flags & CarLaneFlags.Unsafe) == 0)
				{
					for (int m = 0; m < middleConnections.Length; m++)
					{
						...
						if (value.m_ConnectPosition.m_RoadTypes == RoadTypes.None || (isRoundabout && roadPassThrough != RoadTypes.None && ((sourcePosition.m_Owner == owner && !value.m_IsSource) || (targetPosition.m_Owner == owner && value.m_IsSource))))
						{
							continue;
						}
						...
						if (value.m_TargetLane != Entity.Null)
						{
							...
							for (; m < middleConnections.Length; m++)
							{
								...
								if (((middleConnection.m_TargetGroup ^ num6) & num7) == 0 && (((middleConnection.m_TargetFlags ^ laneFlags2) & (LaneFlags.Master | LaneFlags.BicyclesOnly)) == 0 || (middleConnection.m_TargetFlags & laneFlags2 & LaneFlags.Master) != 0))
								{
						...
						float num10 = MathUtils.Distance(curve.m_Bezier, new Line3.Segment(value.m_ConnectPosition.m_Position, value.m_ConnectPosition.m_Position + value.m_ConnectPosition.m_Tangent * num9), out var t);
						num10 += num9 * t.y;
		...
		private float3 CalculateUtilityConnectPosition(NativeList<ConnectPosition> buffer, int2 bufferRange)
		{
			...
			for (int i = bufferRange.x + 1; i < bufferRange.y; i++)
			{
				...
				float3 float2 = connectPosition.m_Tangent;
				if (!(math.lengthsq(float2.xz) > 0.01f))
				{
					continue;
				}
				float3 float3;
				...
				{
					float3 = ((connectPosition.m_SegmentIndex == 0) ? m_StartNodeGeometryData[connectPosition.m_Owner].m_Geometry.m_Middle.d : m_EndNodeGeometryData[connectPosition.m_Owner].m_Geometry.m_Middle.d);
				}
				else
				{
					float3 = m_NodeData[connectPosition.m_Owner].m_Position;
				...
				for (int j = bufferRange.x; j < i; j++)
				{
					...
					float3 float4 = connectPosition2.m_Tangent;
					if (math.lengthsq(float4.xz) > 0.01f)
					{
						float num = math.dot(float2.xz, float4.xz);
						float2 float5 = math.distance(connectPosition.m_Position.xz, connectPosition2.m_Position.xz) * new float2(math.max(0f, num * 0.5f), 1f - math.abs(num) * 0.5f);
						Line2.Segment segment = new Line2.Segment(connectPosition.m_Position.xz + float2.xz * float5.x, connectPosition.m_Position.xz + float2.xz * float5.y);
						Line2.Segment segment2 = new Line2.Segment(connectPosition2.m_Position.xz + float4.xz * float5.x, connectPosition2.m_Position.xz + float4.xz * float5.y);
						MathUtils.Distance(segment, segment2, out var t);
						float4 float6 = new float4
						{
							y = float3.y + connectPosition.m_Position.y - connectPosition.m_BaseHeight + float3.y + connectPosition2.m_Position.y - connectPosition2.m_BaseHeight,
							xz = MathUtils.Position(segment, t.x) + MathUtils.Position(segment2, t.y),
							w = 2f
						};
		...
		private void CreateNodeUtilityLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, NativeList<ConnectPosition> buffer1, NativeList<ConnectPosition> buffer2, NativeList<MiddleConnection> middleConnections, float3 middlePosition, bool isRoundabout, bool isTemp, Temp ownerTemp)
		{
			if (buffer1.Length >= 2)
			{
			...
			for (int n = 0; n < middleConnections.Length; n++)
			{
				...
				if ((value3.m_ConnectPosition.m_UtilityTypes & connectPosition4.m_UtilityTypes) != UtilityTypes.None && value3.m_SourceEdge == connectPosition4.m_Owner && value3.m_TargetLane == Entity.Null)
				{
		...
		private void CreateNodeUtilityLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, NativeList<ConnectPosition> buffer1, NativeList<ConnectPosition> buffer2, NativeList<MiddleConnection> middleConnections, int2 bufferRange, float3 middlePosition, bool isRoundabout, bool isTemp, Temp ownerTemp)
		{
			...
			{
				float3 @float = buffer1[bufferRange.x].m_Position;
				float3 float2 = buffer1[bufferRange.x].m_Tangent;
				position = @float + float2 * math.dot(float2, middlePosition - @float);
				position.y = middlePosition.y;
				position.y = middlePosition.y + @float.y - buffer1[bufferRange.x].m_BaseHeight;
			}
			else
			{
		...
		private void CreateNodeUtilityLane(int jobIndex, int endNodeLaneIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, ConnectPosition connectPosition1, ConnectPosition connectPosition2, NativeList<MiddleConnection> middleConnections, bool isTemp, Temp ownerTemp)
		{
			...
			for (int i = 0; i < middleConnections.Length; i++)
			{
				...
				if ((value2.m_ConnectPosition.m_UtilityTypes & connectPosition1.m_UtilityTypes) != UtilityTypes.None && (value2.m_SourceEdge == connectPosition1.m_Owner || value2.m_SourceEdge == connectPosition2.m_Owner))
				{
		...
		private void CreateNodePedestrianLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, NativeList<ConnectPosition> buffer, NativeList<ConnectPosition> tempBuffer, NativeList<ConnectPosition> tempBuffer2, bool isTemp, Temp ownerTemp, float3 middlePosition, float middleRadius, float roundaboutSize)
		{
			...
			{
				ConnectPosition connectPosition = buffer[num5];
				int j;
				for (j = num5 + 1; j < buffer.Length && !(buffer[j].m_Owner != connectPosition.m_Owner); j++)
				{
				}
				...
				if (m_PrefabCompositionCrosswalks.TryGetBuffer(connectPosition.m_NodeComposition, out var bufferData))
				{
			...
			while (num5 < buffer.Length)
			{
				...
				if (FindNextRightLane(connectPosition2, buffer, out var result))
				{
					...
					if (num > 2)
					{
						CreateNodePedestrianLanes(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, connectPosition2, targetPosition2, tempBuffer2, flag5, flag6, isTemp, ownerTemp, middlePosition, middleRadius, roundaboutSize);
					}
					else if (num == 2)
					{
				...
				{
					CreateNodePedestrianLanes(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, connectPosition2, targetPosition, tempBuffer2, flag5, flag5, isTemp, ownerTemp, middlePosition, middleRadius, roundaboutSize);
				}
				if (!flag4)
				{
					tempBuffer2.Clear();
				}
				if (m_PrefabCompositionCrosswalks.TryGetBuffer(targetPosition.m_NodeComposition, out var bufferData2))
				{
					...
					if (bufferData2.Length >= 1)
					{
						...
						for (int m = 0; m < tempBuffer.Length; m++)
						{
							...
							ConnectPosition value = new ConnectPosition
							{
								m_Position = math.lerp(left2.m_Left.a, left2.m_Right.a, t3)
							};
							value.m_Position.y += @float.y;
							tempBuffer[m] = value;
						}
						for (int n = num5; n < k; n++)
						{
							ConnectPosition value2 = buffer[n];
							float num9 = float.MaxValue;
							int index2 = 0;
							for (int num10 = 0; num10 < tempBuffer.Length; num10++)
							{
								ConnectPosition connectPosition3 = tempBuffer[num10];
								if (connectPosition3.m_Owner == Entity.Null)
								{
									float num11 = math.lengthsq(value2.m_Position - connectPosition3.m_Position);
									if (num11 < num9)
									{
										num9 = num11;
										index2 = num10;
							...
							tempBuffer[index2] = value2;
						}
						for (int num12 = 0; num12 < tempBuffer.Length; num12++)
						{
							ConnectPosition value3 = tempBuffer[num12];
							if (value3.m_Owner == Entity.Null)
							{
								value3.m_Owner = owner;
								value3.m_NodeComposition = targetPosition.m_NodeComposition;
								value3.m_EdgeComposition = targetPosition.m_EdgeComposition;
								value3.m_Tangent = targetPosition.m_Tangent;
								tempBuffer[num12] = value3;
							}
						}
						...
						for (int num13 = 0; num13 < bufferData2.Length; num13++)
						{
							...
							if (flag7)
							{
								...
								if (flag)
								{
									float3 float2 = (sourcePosition.m_Position + targetPosition3.m_Position) * 0.5f;
									Bounds2 bounds2 = new Bounds2(2f, 0f);
									for (int num16 = 0; num16 < buffer.Length; num16++)
									{
										ConnectPosition connectPosition4 = buffer[num16];
										if (!connectPosition4.m_IsSideConnection)
										{
											continue;
										}
										PrefabRef prefabRef = m_PrefabRefData[connectPosition4.m_Owner];
										if ((m_PrefabNetData[prefabRef.m_Prefab].m_RequiredLayers & Layer.Pathway) != Layer.None)
										{
											if (math.dot(targetPosition3.m_Position - sourcePosition.m_Position, connectPosition4.m_Position - float2) < 0f)
											{
												float t4;
												float num17 = MathUtils.Distance(left2.m_Left, connectPosition4.m_Position, out t4);
												float t5;
												float num18 = MathUtils.Distance(segment.m_Right, connectPosition4.m_Position, out t5);
												bounds2.x |= math.select(t4, 2f - t5, num18 < num17);
											}
											else
											{
												float t6;
												float num19 = MathUtils.Distance(left2.m_Right, connectPosition4.m_Position, out t6);
												float t7;
												float num20 = MathUtils.Distance(segment.m_Left, connectPosition4.m_Position, out t7);
									...
									if (math.any(x3))
									{
										...
										float2 float3 = MathUtils.Center(bounds2);
										float3 = math.lerp(float3.x, float3.y, new float2(num14, num15));
										bool2 @bool = float3 > 1f;
										x2.x = 1f - float3.x * 0.5f;
										x2.y = float3.y * 0.5f;
										x2 = math.saturate(x2);
										sourcePosition.m_Position = MathUtils.Position(MathUtils.Lerp(@bool.x ? segment.m_Right : left2.m_Left, @bool.x ? segment.m_Left : left2.m_Right, num14), @bool.x ? (2f - float3.x) : float3.x);
										targetPosition3.m_Position = MathUtils.Position(MathUtils.Lerp(@bool.y ? segment.m_Right : left2.m_Left, @bool.y ? segment.m_Left : left2.m_Right, num15), @bool.y ? (2f - float3.y) : float3.y);
									}
								}
								if (num13 == 0)
								{
							...
							CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition, targetPosition3, pathNode, endPathNode, default(float2), isCrosswalk: true, isSideConnection: false, isTemp, ownerTemp, fixedTangents: false, (netCompositionCrosswalk.m_Flags & LaneFlags.CrossRoad) != 0, out var _, out var _, out var endNode);
							pathNode = endNode;
							endPathNode = endNode;
						}
					}
			...
			{
				int2 @int = stackList[num21];
				for (int num22 = 0; num22 < num21; num22++)
				{
					int2 int2 = stackList[num22];
					if (math.all(@int != int2.yx))
					{
						ConnectPosition sourcePosition2 = buffer[@int.x];
						ConnectPosition targetPosition4 = buffer[int2.x];
						CreateNodePedestrianLanes(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition2, targetPosition4, tempBuffer2, sourceHasSingleLane: true, targetHasSingleLane: true, isTemp, ownerTemp, middlePosition, middleRadius, roundaboutSize);
					}
				}
			}
		}

		private void CreateNodePedestrianLanes(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, ConnectPosition sourcePosition, ConnectPosition targetPosition, NativeList<ConnectPosition> sideConnections, bool sourceHasSingleLane, bool targetHasSingleLane, bool isTemp, Temp ownerTemp, float3 middlePosition, float middleRadius, float roundaboutSize)
		{
			PathNode endNode2;
			float t;
			Bezier4x3 curve2;
			if (middleRadius == 0f)
			{
				...
				CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition2, targetPosition2, default(PathNode), endNode, default(float2), isCrosswalk: false, isSideConnection: false, isTemp, ownerTemp, fixedTangents: false, hasSignals: true, out var curve, out var middleNode, out endNode2);
				for (int i = 0; i < sideConnections.Length; i++)
				{
					...
					CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition3, targetPosition3, pathNode, pathNode, default(float2), isCrosswalk: false, isSideConnection: true, isTemp, ownerTemp, fixedTangents: false, hasSignals: true, out curve2, out endNode2, out endNode);
				}
				return;
			}
			...
			float num3 = middleRadius + roundaboutSize - math.lerp(start, end, 0.5f);
			...
			float num4 = math.select(MathUtils.RotationAngleLeft(float2, toVector), MathF.PI * 2f, test);
			int num5 = 1 + math.max(1, Mathf.CeilToInt(num4 * (2f / MathF.PI) - 0.003141593f));
			if (num5 == 2)
			{
			...
			if (num5 >= 2)
			{
				for (int j = 0; j < sideConnections.Length; j++)
				{
					...
					if (reference.m_Order > num4)
					{
						float num7 = MathUtils.RotationAngleRight(float2, toVector2);
						reference.m_Order = math.select(0f, num4, num7 > reference.m_Order - num4);
					}
				}
			}
			for (int k = 1; k <= num5; k++)
			{
				float num8 = math.saturate(((float)k - 0.5f) / ((float)num5 - 1f));
				...
				{
					float2 float3 = MathUtils.RotateLeft(float2, num4 * num8);
					...
					connectPosition2.m_BaseHeight = math.lerp(sourcePosition.m_BaseHeight, targetPosition.m_BaseHeight, num8);
					connectPosition2.m_Position.y = math.lerp(sourcePosition.m_Position.y, targetPosition.m_Position.y, num8);
					connectPosition2.m_Position.xz = middlePosition.xz + float3 * num3;
				...
				if (k > 1 && k < num5)
				{
					CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition4, targetPosition4, pathNode2, pathNode2, float4, isCrosswalk: false, isSideConnection: false, isTemp, ownerTemp, fixedTangents: false, hasSignals: true, out curve3, out middleNode2, out var endNode3);
					pathNode2 = endNode3;
				}
				else
				{
					float num9 = math.lerp(num6, num8, 0.5f);
					float2 float5 = MathUtils.RotateLeft(float2, num4 * num9);
					...
					centerPosition.xz += float5 * num3;
					float3 centerTangent = new float3
					{
						xz = MathUtils.Left(float5)
					};
					if (k == 1)
					{
						PresetCurve(ref sourcePosition4, ref targetPosition4, middlePosition, centerPosition, centerTangent, num3, 0f, num4 / (float)num5, 2f);
					}
					else
					{
						PresetCurve(ref sourcePosition4, ref targetPosition4, middlePosition, centerPosition, centerTangent, num3, num4 / (float)num5, 0f, 2f);
					}
					float4 = math.select(float4, 0f, new bool2(k == 1, k == num5));
					CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition4, targetPosition4, pathNode2, pathNode2, float4, isCrosswalk: false, isSideConnection: false, isTemp, ownerTemp, fixedTangents: true, hasSignals: true, out curve3, out middleNode2, out var endNode4);
					pathNode2 = endNode4;
				}
				for (int l = 0; l < sideConnections.Length; l++)
				{
					ConnectPosition targetPosition5 = sideConnections[l];
					if ((!(targetPosition5.m_Order < num4 * num6) || k == 1) && (!(targetPosition5.m_Order >= num4 * num8) || k == num5))
					{
						float num10 = MathUtils.Distance(curve3, targetPosition5.m_Position, out t);
						float3 float6 = targetPosition5.m_Position + targetPosition5.m_Tangent * (num10 * 0.5f);
						MathUtils.Distance(curve3, float6, out var t3);
						...
						PathNode pathNode3 = new PathNode(middleNode2, t3);
						CreateNodePedestrianLane(jobIndex, ref nodeLaneIndex, ref random, owner, laneBuffer, sourcePosition5, targetPosition5, pathNode3, pathNode3, default(float2), isCrosswalk: false, isSideConnection: true, isTemp, ownerTemp, fixedTangents: false, hasSignals: true, out curve2, out var _, out endNode2);
					}
				}
				connectPosition = connectPosition2;
				connectPosition.m_Tangent = -connectPosition2.m_Tangent;
		...
		private void CreateNodePedestrianLane(int jobIndex, ref int nodeLaneIndex, ref Unity.Mathematics.Random random, Entity owner, LaneBuffer laneBuffer, ConnectPosition sourcePosition, ConnectPosition targetPosition, PathNode startPathNode, PathNode endPathNode, float2 overrideWidths, bool isCrosswalk, bool isSideConnection, bool isTemp, Temp ownerTemp, bool fixedTangents, bool hasSignals, out Bezier4x3 curve, out PathNode middleNode, out PathNode endNode)
		{
			...
			component4.m_Flags |= ((component4.m_WidthOffset.x != 0f) ? NodeLaneFlags.StartWidthOffset : ((NodeLaneFlags)0));
			...
			if (isCrosswalk)
			{
				...
				if (component5.m_Length >= 0.1f)
				{
					...
					@float = math.tan(MathF.PI / 2f - math.acos(math.saturate(math.abs(@float))));
					@float = @float * (netLaneData3.m_Width + component4.m_WidthOffset) * 0.5f;
			...
			else
			{
				...
				if ((sourcePosition.m_RoadTypes & targetPosition.m_RoadTypes & RoadTypes.Bicycle) != RoadTypes.None)
				{
	...
	private struct TypeHandle
	{
		...
		public void __AssignHandles(ref SystemState state)
		{
			...
			__Game_Net_BuildOrder_RO_ComponentLookup = state.GetComponentLookup<BuildOrder>(isReadOnly: true);
	...
	protected override void OnUpdate()
	{
		JobHandle jobHandle = JobChunkExtensions.ScheduleParallel(new UpdateLanesJob
		{
			...
			m_PedestrianLaneData = InternalCompilerInterface.GetComponentLookup(ref __TypeHandle.__Game_Prefabs_PedestrianLaneData_RO_ComponentLookup, ref base.CheckedStateRef),
