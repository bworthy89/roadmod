...
public class EconomyPrefab : PrefabBase
{
	...
	[Tooltip("The range of initial wealth for tourists when they spawn in the city.")]
	public int m_TouristInitialWealthRange = 2000;

	[Tooltip("The offset value for the initial wealth of tourists when they spawn in the city.")]
	public int m_TouristInitialWealthOffset = 1000;
	...
	[Tooltip("Cost how many office resources to produce one unit of industrial resource")]
	public int m_OfficeResourceConsumedPerIndustrialUnit = 1;
	...
	[Tooltip("Profit range (X to Y) for mapping profitability to building color. Profit equal to min results in color 0, max results in color 255. X must less than 0 and Y must greater than 0")]
	public int2 m_ProfitabilityRange = new int2(-12700, 12700);
	...
	public override void LateInitialize(EntityManager entityManager, Entity entity)
	{
		...
		entityManager.SetComponentData(entity, new EconomyParameterData
		{
			...
			m_TouristInitialWealthRange = m_TouristInitialWealthRange,
			m_TouristInitialWealthOffset = m_TouristInitialWealthOffset,
			...
			m_OfficeResourceConsumedPerIndustrialUnit = m_OfficeResourceConsumedPerIndustrialUnit,
			...
			m_ProfitabilityRange = m_ProfitabilityRange
		});
	}
}
