...
public class ServiceFeeSystem : GameSystemBase, IServiceFeeSystem, IDefaultSerializable, ISerializable, IPostDeserialize
{
	public struct FeeEvent : ISerializable
	{
		...
		{
			PlayerResource value = m_Resource;
			writer.Write((int)value);
			float value2 = m_Amount;
			writer.Write(value2);
			float value3 = m_Cost;
			writer.Write(value3);
			bool value4 = m_Outside;
			writer.Write(value4);
		}
		...
		public void Deserialize<TReader>(TReader reader) where TReader : IReader
		{
			...
			ref float value2 = ref m_Amount;
			reader.Read(out value2);
			ref float value3 = ref m_Cost;
			reader.Read(out value3);
			ref bool value4 = ref m_Outside;
