...
public class ParkingLaneDataSystem : GameSystemBase
{
	...
	private struct TypeHandle
	{
		...
		public void __AssignHandles(ref SystemState state)
		{
			...
			__Game_Net_GarageLane_RW_ComponentTypeHandle = state.GetComponentTypeHandle<GarageLane>();
			...
			__Game_Buildings_ParkingFacility_RO_ComponentLookup = state.GetComponentLookup<Game.Buildings.ParkingFacility>(isReadOnly: true);
			...
			__Game_Buildings_BuildingModifier_RO_BufferLookup = state.GetBufferLookup<BuildingModifier>(isReadOnly: true);
