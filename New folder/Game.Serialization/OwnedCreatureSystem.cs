...
{
	[BurstCompile]
	private struct OwnedCreatureJob : IJobChunk
	{
		[ReadOnly]
	...
	{
		base.OnCreate();
		m_Query = GetEntityQuery(ComponentType.ReadOnly<Creature>(), ComponentType.ReadOnly<Owner>());
	...
	{
		OwnedCreatureJob jobData = new OwnedCreatureJob
		{
