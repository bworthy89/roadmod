...
public class PetSystem : GameSystemBase
{
	...
	private struct PetJob : IJobChunk
	{
		...
		public void Execute(in ArchetypeChunk chunk, int unfilteredChunkIndex, bool useEnabledMask, in v128 chunkEnabledMask)
		{
			...
			for (int i = 0; i < nativeArray2.Length; i++)
			{
				...
				{
					Pet value = m_PetData[currentTransport.m_CurrentTransport];
					value.m_HouseholdPet = householdPet;
					m_PetData[currentTransport.m_CurrentTransport] = value;
				}
			}
		}
	...
	protected override void OnUpdate()
	{
		PetJob jobData = new PetJob
		{
			...
			m_PetData = InternalCompilerInterface.GetComponentLookup(ref __TypeHandle.__Game_Creatures_Pet_RW_ComponentLookup, ref base.CheckedStateRef)
		};
